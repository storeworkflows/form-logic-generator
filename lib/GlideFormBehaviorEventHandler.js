...
var GlideFormBehaviorEventHandler = /** @class */ (function () {
    ...
    GlideFormBehaviorEventHandler.prototype.onPropChange = function (type, name, propName, value) {
        console.log("onPropChanged", { type: type, name: name, propName: propName, value: value, state: this.state });
        switch (type) {
            ...
            case PROPERTY_CHANGE_FIELD: {
                this._updateState(__assign({}, lodash_1.default.cloneDeep(this.state)));
                break;
            }
        }
    };
