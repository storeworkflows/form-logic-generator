    ...
    GlideFormBehaviorEventHandler.prototype.onPropChange = function (type, name, propName, value) {
        ...
        switch (type) {
            ...
            case PROPERTY.FORM:
                ...
                break;
            case PROPERTY.FIELD: {
                this._updateState(__assign(__assign({}, this.state), { layout: __assign(__assign({}, this.state.layout), { fieldStates: __assign(__assign({}, this.state.layout.formFieldValues), (_a = {}, _a[name] = __assign(__assign({}, this.state.layout.formFieldValues[name]), (_b = {}, _b[propName] = value, _b)), _a)) }) }));
                break;
            }
        }
    };
    GlideFormBehaviorEventHandler.prototype.onLiveUpdated = function () {
        // @ts-ignore
        console.log.apply(console, __spreadArray(["LIVE UPDATE"], arguments));
    };
