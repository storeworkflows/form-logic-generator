...
var PlatformResource = /** @class */ (function () {
    ...
    PlatformResource.assignPlatformResources = function (sendRequest) {
        ...
        var glideRequest = GlideRequest_1.default(sendRequest);
    ...
    PlatformResource.prototype.loadPlatformResources = function () {
        var sendRequest = http_1.sendRequestFactory();
        // @ts-ignore
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.loadPlatformResources()];
                    case 1:
                        resources = _a.sent();
                        currentResources = Globals_1.default.get(id);
                        if (!currentResources)
                            throw new Error("Error when set default values");
