...
var RecordForm = /** @class */ (function () {
    ...
    RecordForm.prototype.isReadonly = function (state, view, isWhitelistedForEdit) {
    ...
    ;
    RecordForm.prototype.getRecordValueProps = function (recordValues, fieldName) {
    ...
    RecordForm.prototype.getUiDomain = function (data, referringTable, referringRecordId) {
        var _this = this;
    ...
    ;
    RecordForm.prototype.updatingProperties = function (data, state, properties) {
        try {
            ...
            console.log({ dataSources: dataSources_1, state: state, properties: properties, computedView: computedView, isWhitelistedForEdit: isWhitelistedForEdit });
    ...
    ;
    RecordForm.prototype.load = function (variables, id, setState) {
