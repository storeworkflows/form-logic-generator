...
var GlideFormEnvironment = /** @class */ (function () {
    ...
    GlideFormEnvironment.prototype.configureWithOptions = function (_a) {
        ...
        var _m = data.record, table = _m.table, sysId = _m.sysId, view = _m.view, trueTable = _m.trueTable;
        ...
        this._scope.setGlideAPIs(this === null || this === void 0 ? void 0 : this.glideAjax, this === null || this === void 0 ? void 0 : this.glideRecord);
        this._scope.setModal(this === null || this === void 0 ? void 0 : this.glideModalFactory, formModal);
        this._scope.setUser(this === null || this === void 0 ? void 0 : this.glideUser, (_b = data === null || data === void 0 ? void 0 : data.currentUser) === null || _b === void 0 ? void 0 : _b.user);
        this._scope.setITSMWorkbench();
        this._scope.setUIScripts(this.uiScriptFactory, (_c = data.uiScripts) === null || _c === void 0 ? void 0 : _c.scripts);
        ...
        this._scope.setUIActions((_d = data === null || data === void 0 ? void 0 : data.uiActions) === null || _d === void 0 ? void 0 : _d.formActions, submitSubscriber, sendRequest, { table: table, sysId: sysId });
        ...
        var liveUpdatedSubscriber = function (liveUpdatedFields) {
            console.log("Live update", { liveUpdatedFields: liveUpdatedFields });
        ...
        this._scope.setForm(this.glideFormFactory, changeSubscriber, propChangeSubscriber, stateSubscriber, liveUpdatedSubscriber, {
            tableName: trueTable,
            sysId: sysId,
            formFields: (_e = data.layout) === null || _e === void 0 ? void 0 : _e.formFields,
            encodedRecord: (_f = data.layout) === null || _f === void 0 ? void 0 : _f.encodedRecord,
            sections: (_g = data.layout) === null || _g === void 0 ? void 0 : _g.sections,
            relatedLists: (_h = data.layout) === null || _h === void 0 ? void 0 : _h.relatedLists,
            attachments: ((_j = data === null || data === void 0 ? void 0 : data.attachments) === null || _j === void 0 ? void 0 : _j.props) || (data === null || data === void 0 ? void 0 : data.attachments),
            viewName: view,
            modal: formModal,
            variablesLayout: (_k = data === null || data === void 0 ? void 0 : data.layout) === null || _k === void 0 ? void 0 : _k.variablesLayout,
            reloadForm: reloadForm,
            uniqueValue: (_l = data === null || data === void 0 ? void 0 : data.layout) === null || _l === void 0 ? void 0 : _l.sysId
        });
