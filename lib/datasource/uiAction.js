...
var createTransform = function (getValueOrDefault) { return function (data, state, properties) {
    ...
    var uiActionNodes = transformActionNodes(actionNodeData);
    var formActions = !uiActionNodes ? [] : getActionsFromNodes(actionNodeData);
    ...
    console.log({ actionNodeData: actionNodeData, uiActionNodes: uiActionNodes, formActions: formActions, encodedQuery: encodedQuery, configurationItem: configurationItem, messages: messages, isFormReadonly: isFormReadonly });
    return {
