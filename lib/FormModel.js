...
var FormModel = /** @class */ (function () {
    ...
    FormModel.prototype.load = function (variables, id, setState) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var dataSources, query, fetch_1, response, data, _c, formData, configurationItems, globals_1, gEnv, gForm, gUser, gUIActions, _d, fields, sections, isNewRecord, isValidRecord, formActions, error_1;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        _c = this.updatingProperties(data, __assign(__assign({}, variables), { properties: __assign({}, variables) }), __assign({}, variables)), formData = _c.formData, configurationItems = _c.configurationItems;
                    ...
                    case 4:
                        ...
                        (_a = globals_1.eventHandler) === null || _a === void 0 ? void 0 : _a.setUpdateState(setState);
                        ...
                        gEnv.onLiveUpdated((_b = globals_1.eventHandler) === null || _b === void 0 ? void 0 : _b.onLiveUpdated);
                        gEnv.initialize();
                        gForm = gEnv.gForm, gUser = gEnv.gUser, gUIActions = gEnv.gUIActions;
                        _d = formData.layout, fields = _d.formFieldValues, sections = _d.sections, isNewRecord = _d.isNewRecord, isValidRecord = _d.isValidRecord, formActions = formData.uiActions.formActions;
                        return [2 /*return*/, {
                                gForm: gForm, gUser: gUser, formData: formData
                            }];
                    case 5:
                        error_1 = _e.sent();
