...
var FormModel = /** @class */ (function () {
    ...
    FormModel.prototype.load = function (variables, id, setState) {
        return __awaiter(this, void 0, void 0, function () {
            var fetch_1, response, data, _a, formData, configurationItems, globals_1, gEnv, gForm, gUser, gUIActions, _b, fields, sections, isNewRecord, isValidRecord, uiActions, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        console.log(id, Globals_1.default);
                    ...
                    case 4:
                        ...
                        _b = formData.layout, fields = _b.formFieldValues, sections = _b.sections, isNewRecord = _b.isNewRecord, isValidRecord = _b.isValidRecord, uiActions = formData.uiActions;
                        return [2 /*return*/, {
                                gForm: gForm, gUser: gUser,
                                gUIActions: formData,
                                fields: fields, sections: sections, isNewRecord: isNewRecord, isValidRecord: isValidRecord
                            }];
                    case 5:
                        error_1 = _c.sent();
