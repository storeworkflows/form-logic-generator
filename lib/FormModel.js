...
var FormModel = /** @class */ (function () {
    ...
    FormModel.prototype.load = function (variables, id, setState) {
        return __awaiter(this, void 0, void 0, function () {
            var dataSources, query, fetch_1, response, data, _a, formData, configurationItems, globals_1, gEnv, gForm, gUser, gUIActions, _b, fields, sections, isNewRecord, isValidRecord, formActions, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        _b = formData.layout, fields = _b.formFieldValues, sections = _b.sections, isNewRecord = _b.isNewRecord, isValidRecord = _b.isValidRecord, formActions = formData.uiActions.formActions;
                        return [2 /*return*/, {
                                gForm: gForm, gUser: gUser,
                                gUIActions: formActions,
